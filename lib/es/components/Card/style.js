...
export var CardTitle = styled(Title)(_templateObject5(), ellipsisStyle, getFromTheme('palette.black.500'), getFromTheme('typography.fontWeight.semiBold'));
export var CardSubTitle = styled(Subtitle)(_templateObject6(), ellipsisStyle);
