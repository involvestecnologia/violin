...
export var StyledButton = styled.button(_templateObject5(), ifProp('small', '10px', ifProp('large', '16px', '12px')), getFromTheme('typography.fontFamily'), getFromTheme('typography.fontWeight.semiBold'), getFromTheme('common.transition'), ifProp('small', '30px', ifProp('large', '52px', '40px')), ifProp('small', rem(13), ifProp('large', rem(18), rem(14))), ifProp('block', 'flex', 'inline-flex'), ifProp('block', '100%', ifProp('iconOnly', ifProp('small', '30px', ifProp('large', '52px', '40px')), 'auto')), ifNotProp('iconOnly', '80px', 'auto'), function (props) {
...
export var StyledIcon = styled(Icon)(_templateObject6(), function (_ref) {
  var right = _ref.right;
  return right ? ifProp('hasChildren', '0 0 0 5px', '0') : ifProp('hasChildren', '0 5px 0 0', '0');
});