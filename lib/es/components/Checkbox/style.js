...
export var InputStyled = styled.input(_templateObject8(), Svg, Svg, Rect, getFromTheme('palette.primary.500'), getFromTheme('palette.primary.500'), Rect, getFromTheme('palette.primary.700'), getFromTheme('palette.primary.700'), Svg, Rect, getFromTheme('palette.primary.500'), Svg, Svg, Rect, getFromTheme('palette.primary.700'), getFromTheme('palette.primary.700'), Svg, CheckedIcon, IndeterminateIcon, Svg, CheckedIcon, IndeterminateIcon, Svg, Rect, withProp(getFromTheme('palette.misc.black'), transparentize(0.85)), Svg, Rect, Svg, Rect, withProp(getFromTheme('palette.misc.black'), transparentize(0.85)), withProp(getFromTheme('palette.misc.black'), transparentize(0.85)), Label, Svg);