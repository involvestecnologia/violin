...
var arrow = css(_templateObject(), getFromTheme('palette.black.900'));
var top = css(_templateObject2(), function (_ref) {
  var position = _ref.position;
  return position.left + position.width / 2;
}, function (_ref2) {
  var position = _ref2.position;
  return position.top - 10;
}, ifProp('fade', '0', '5px'), arrow);
var topLeft = css(_templateObject3(), function (_ref3) {
...
var topRight = css(_templateObject4(), function (_ref5) {
...
var bottom = css(_templateObject5(), function (_ref7) {
...
var bottomLeft = css(_templateObject6(), function (_ref9) {
...
var bottomRight = css(_templateObject7(), function (_ref11) {
...
var left = css(_templateObject8(), function (_ref13) {
...
var leftTop = css(_templateObject9(), function (_ref15) {
...
var leftBottom = css(_templateObject10(), function (_ref17) {
...
var right = css(_templateObject11(), function (_ref19) {
...
var rightTop = css(_templateObject12(), function (_ref21) {
...
var rightBottom = css(_templateObject13(), function (_ref23) {
...
export var Balloon = styled.div(_templateObject14(), getFromTheme('zIndex.z6'), function (props) {
...
}, getFromTheme('palette.black.900'), getFromTheme('palette.misc.white'), getFromTheme('typography.fontSize.small'), ifProp('fade', '1', '0'));
export var Trigger = styled.span(_templateObject15());