...
export var Tooltip = function Tooltip(_ref) {
  ...
  var timerShowTip = useRef();
  var timerHideTip = useRef();

  var offsetTriggerPosition = function offsetTriggerPosition(element) {
  ...
  useEffect(function () {
    var Elem = function Elem() {
      return React.cloneElement(children, _extends({}, children.props, {
  ...
  return React.createElement(React.Fragment, null, triggerElement, showTip && React.createElement(Tip, {
...
var Tip = function Tip(_ref2) {
  ...
  var component = React.createElement(Balloon, _extends({
    ref: tooltipElement,
    fade: fade,
