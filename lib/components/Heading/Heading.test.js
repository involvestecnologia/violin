...
describe('Heading', function () {
  test('should render correctly', function () {
    var _render = (0, _react2.render)(_react["default"].createElement(_Heading.Heading, null, "Lorem ipsum")),
        getByText = _render.getByText;

    expect(getByText('Lorem ipsum')).toBeInTheDocument();
  });
  test('should have style size correctly', function () {
    var _render2 = (0, _react2.render)(_react["default"].createElement(_Heading.Heading, {
      size: "h1"
    }, "Heading")),
    ...
    rerender(_react["default"].createElement(_Heading.Heading, {
      size: "h2"
    }, "Lorem ipsum"));
