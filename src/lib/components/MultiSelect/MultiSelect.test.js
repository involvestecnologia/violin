...
describe('Select', () => {
  ...
  test('should select option item when click option item menu', () => {
    ...
    fireEvent.mouseDown(getByTestId('select-input'));
    fireEvent.click(queryAllByTestId('select-menu-item')[2]);
    expect(getByTestId('select-input-value')).toHaveValue(['red']);
  });
  ...
  test('should render items correctly when options is grouped', () => {
    ...
    expect(queryAllByTestId('select-menu-item')[1]).toHaveTextContent('Colors');
    expect(queryAllByTestId('select-menu-item')[2]).toHaveTextContent('Blue');
    expect(queryAllByTestId('select-menu-item')[3]).toHaveTextContent('Red');
    expect(queryAllByTestId('select-menu-item')[4]).toHaveTextContent('Green');
    expect(queryAllByTestId('select-menu-item')[5]).toHaveTextContent('Country');
    expect(queryAllByTestId('select-menu-item')[6]).toHaveTextContent('Brazil');
    expect(queryAllByTestId('select-menu-item')[7]).toHaveTextContent('Portugal');
    expect(queryAllByTestId('select-menu-item')[8]).toHaveTextContent('United States');
  });
  ...
  test('should match value selected when select item', () => {
    ...
    fireEvent.keyDown(document, { keyCode: 13 }); // Enter key
    expect(getByTestId('select-input-value')).toHaveValue(['blue', 'red']);
  });
});
