...
In order to use the font Icon component, you must first add the [Material icons](https://material.io/tools/icons/) font with *Round* and *Outlined* style. You can load via Google Web Fonts:
